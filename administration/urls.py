...
urlpatterns = [
    ...
    url(r'^learn_page_delete/(?P<id>[\w\-]+)/$', views.LearnPageView.delete, name='learn_page_delete'),
    ...
    url(r'^about_page_delete/(?P<id>[\w\-]+)/$', views.AboutPageView.delete, name='about_page_delete'),
