...
class Categories(models.Model):
    ...
    rsrv_no_field_1 = models.IntegerField(null=True,default=0)
    rsrv_no_field_2 = models.IntegerField(null=True,default=0)
    rsrv_no_field_3 = models.IntegerField(null=True,default=0)
    rsrv_date_field_1 = models.DateTimeField(blank=True, null=True)
    rsrv_date_field_2 = models.DateTimeField(blank=True, null=True)
    rsrv_date_field_3 = models.DateTimeField(blank=True, null=True)
    active = models.NullBooleanField()
...
class Products(models.Model):
    ...
    description_3 = models.CharField(max_length=100,blank=True,null=True)
    description_4 = models.CharField(max_length=100,blank=True,null=True)
    description_5 = models.CharField(max_length=100,blank=True,null=True)
    rsrv_char_field_1 = models.TextField(blank=True, null=True)
    rsrv_char_field_2 = models.TextField(blank=True, null=True)
    rsrv_char_field_3 = models.TextField(blank=True, null=True)
    rsrv_no_field_1 = models.IntegerField(null=True)
    rsrv_no_field_2 = models.IntegerField(null=True)
    rsrv_no_field_3 = models.IntegerField(null=True)
    rsrv_photo_field_1 = models.FileField(upload_to=user_directory_path, null=True)
    rsrv_photo_field_2 = models.FileField(upload_to=user_directory_path, null=True)
    rsrv_photo_field_3 = models.FileField(upload_to=user_directory_path, null=True)
    rsrv_date_field_1 = models.DateTimeField(blank=True, null=True)
    rsrv_date_field_2 = models.DateTimeField(blank=True, null=True)
    rsrv_date_field_3 = models.DateTimeField(blank=True, null=True)
    active = models.NullBooleanField()
...
class Activities(models.Model):
    ...
    name = models.CharField(max_length=100)
    description = models.TextField(null=True, blank=True)
    photo_1 = models.FileField(upload_to='activity_images', null=True)
    photo_2 = models.FileField(upload_to='activity_images', null=True)
    photo_3 = models.FileField(upload_to='activity_images', null=True)
    photo_4 = models.FileField(upload_to='activity_images', null=True)
    photo_5 = models.FileField(upload_to='activity_images', null=True)
    rsrv_char_field_1 = models.TextField(null=True, blank=True)
    rsrv_char_field_2 = models.TextField(null=True, blank=True)
    rsrv_char_field_3 = models.TextField(null=True, blank=True)
    rsrv_no_field_1 = models.IntegerField(null=True)
    rsrv_no_field_2 = models.IntegerField(null=True)
    rsrv_no_field_3 = models.IntegerField(null=True)
    rsrv_photo_field_1 = models.FileField(upload_to='activity_images', null=True)
    rsrv_photo_field_2 = models.FileField(upload_to='activity_images', null=True)
    rsrv_photo_field_3 = models.FileField(upload_to='activity_images', null=True)
    rsrv_date_field_1 = models.DateTimeField(blank=True, null=True)
    rsrv_date_field_2 = models.DateTimeField(blank=True, null=True)
    rsrv_date_field_3 = models.DateTimeField(blank=True, null=True)
    active = models.NullBooleanField()
...
class Services(models.Model):
    ...
    name = models.CharField(max_length=100)
    description = models.TextField(null=True, blank=True)
    photo_1 = models.FileField(upload_to='service_images', null=True)
    photo_2 = models.FileField(upload_to='service_images', null=True)
    photo_3 = models.FileField(upload_to='service_images', null=True)
    photo_4 = models.FileField(upload_to='service_images', null=True)
    photo_5 = models.FileField(upload_to='service_images', null=True)
    rsrv_char_field_1 = models.TextField(null=True, blank=True)
    rsrv_char_field_2 = models.TextField(null=True, blank=True)
    rsrv_char_field_3 = models.TextField(null=True, blank=True)
    rsrv_no_field_1 = models.IntegerField(null=True)
    rsrv_no_field_2 = models.IntegerField(null=True)
    rsrv_no_field_3 = models.IntegerField(null=True)
    rsrv_photo_field_1 = models.FileField(upload_to='service_images', null=True)
    rsrv_photo_field_2 = models.FileField(upload_to='service_images', null=True)
    rsrv_photo_field_3 = models.FileField(upload_to='service_images', null=True)
    rsrv_date_field_1 = models.DateTimeField(blank=True, null=True)
    rsrv_date_field_2 = models.DateTimeField(blank=True, null=True)
    rsrv_date_field_3 = models.DateTimeField(blank=True, null=True)
    active = models.NullBooleanField()
